  ...
  return (
    <div
        ...
        <motion.div
            ...
            className='absolute top-10 2xl:top-20 selectionwhite font-montserrat font-bold text-6xl lg:text-7xl 2xl:text-8xl'>
            Experience
        </motion.div>
        ...
        <motion.div 
            ...
            <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[280px] md:w-[400px] lg:w-[501px] xl:w-[600px] 2xl:w-[800px] snap-center p-5 
            ...
            <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[280px] md:w-[401px] lg:w-[503px] xl:w-[600px] 2xl:w-[802px] snap-center p-5 
            bg-black font-montserrat transition-opacity duration-150 overflow-hidden border border-white hover:border-2'>
                <div className='px-1 2xl:p-5'>
