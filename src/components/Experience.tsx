                    ...
                    <div className='px-1 2xl:p-5'>
                        ...
                        <ul className='list-disc space-y-2 ml-5 2xl:py-3 text-xs md:text-base xl:text-md 2xl:text-xl text-left'>
                            ...
                            <li className='selectionwhite'>Worked with over 1000 individuals and brands such as 
                                <a className='font-medium decoration-wavy underline text-blue-700 md:text-white md:hover:text-blue-700' href="https://www.principal-it.com/" target="_blank"> Principal IT</a> and 
                                <a className='font-medium decoration-wavy underline text-blue-700 md:text-white md:hover:text-blue-700' href="https://barkbutter.au/" target="_blank"> Bark Butter</a>.</li>
                            <li className='selectionwhite'>Built a strong and loyal customer base, amassing over 1100 orders and 900 5-star reviews. 
                            Visit <a className='font-medium decoration-wavy underline text-blue-700 md:text-white md:hover:text-blue-700' href="https://www.fiverr.com/martinbartolo" target="_blank">https://www.fiverr.com/martinbartolo </a> 
