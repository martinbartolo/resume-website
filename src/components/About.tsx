...
export default function About({}: Props) {
    return (
        ...
        <div className='xl:scale-95 relative max-w-full h-fit space-y-10 skew-y-[5deg] px-10 mx-auto'>
            ...
            <motion.h1 className='relative text-center font-montserrat font-bold text-5xl md:text-7xl 2xl:text-8xl'
                initial={{ opacity: 0 }}
            ...
            <motion.p className='font-montserrat max-w-prose text-justify text-sm md:text-lg xl:text-xl 2xl:text-2xl'
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}>
                I&apos;ve had the privilege of experiencing life in different parts of the world - from the island of Malta where I grew up, to the UK where I lived and studied for a year. 
                ...
                Aside from exploring the great outdoors, music has always been my passion. I have a <a className='decoration-wavy underline text-blue-700 md:text-white md:hover:text-blue-700' href="https://www.youtube.com/@yesok" target="_blank">YouTube channel </a> with over 4k subscribers and 1.25m views where I share my music 
