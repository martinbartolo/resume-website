...
<div className='flex flex-col relative max-w-full h-screen bg-black md:flex-row px-10 justify-evenly mx-auto items-center border-y border-white'>
    <motion.h3
        ...
        className='absolute top-10 selectionwhite font-playfair text-6xl md:text-7xl 2xl:text-8xl'>
        About Me
    </motion.h3>
    <motion.img
        initial={{
    ...
    viewport={{ once: true }}
    transition={{ duration: 1 }}
    className='font-montserrat text-justify selectionwhite md:text-lg xl:text-xl 2xl:text-2xl space-y-10 pt-6 md:px-10'>
